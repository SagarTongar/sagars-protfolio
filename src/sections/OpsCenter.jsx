...
const skills = [
  {
    ...
    items: ["AWS / EKS", "GCP / GKE", "Terraform", "Kubernetes", "Docker", "Helm", "JFROG-Artifactoy"],
                    ...
                    <div className="flex flex-wrap gap-2 mt-auto">
                      {skill.items.map((item, i) => (
                        <motion.span
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="px-4 py-2 bg-slate-800/80 border border-slate-700 rounded-xl text-sm font-bold text-slate-300 shadow-sm hover:border-blue-400 hover:text-white hover:bg-slate-700/80 hover:shadow-blue-900/50 hover:shadow-lg transition-all cursor-pointer"
                        >
                          {item}
                        </motion.span>
                      ))}
